...
export const SUBJECTS = [
  ...
  { value: "sgsd", label: "SGSD" },
  { value: "dccn", label: "DCCN" },
  { value: "cloud computing", label: "Cloud Computing" },
  { value: "software engineering", label: "Software Engineering" },
  { value: "ethical hacking", label: "Ethical Hacking" },
  { value: "no-sql database", label: "No-SQL Database" },
  { value: "web technology frameworks", label: "Web Technology Frameworks" },
  { value: "ccn", label: "CCN" },
  { value: "adc", label: "ADC" },
  { value: "ml practical", label: "ML Practical" },
  { value: "software testing", label: "Software Testing" },
  { value: "mechatronics", label: "Mechatronics" },
  { value: "low power vlsi", label: "Low Power VLSI" },
  { value: "cad", label: "CAD" },
  { value: "dmm", label: "DMM" },
